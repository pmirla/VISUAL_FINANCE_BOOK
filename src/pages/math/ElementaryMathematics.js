...
function Vectors() {
  ...
  return (
    <div>
      <h2>Vectors </h2>
      {showFlag && <GGBInject newParameters={newParameters1} id="someId1" />}
      <button onClick={handleClick}>Show me Vector Additon</button>
      {showFlag2 && <GGBInject newParameters={newParameters2} id="someId1" />}
      <button onClick={handleClick2}>Show me Quiz</button>
    </div>
  );
}
