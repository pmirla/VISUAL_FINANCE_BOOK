...
function Variables() {
  ...
  return (
    <div>
      ...
      <button onClick={handleClick}>Show me Interactive</button>
      {showFlag2 && <GGBInject newParameters={newParameters2} id="someId1" />}
      <button onClick={handleClick2}>Show me Interactive2</button>
      <button onClick={handleClick3}>Show me Interactive3</button>
    </div>
  );
}
